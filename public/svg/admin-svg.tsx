...
const AdminSvg = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      className={className}
    >
      <g opacity=".1" fill="#000000" className="color000000 svgShape">
        <path
          fill="#167ffc"
      ...
      <path
        ...
        className="colorfcd2b1 svgShape"
      ></path>
      <path
        fill="#595bd4"
      ...
      <path
        ...
        opacity=".32"
        className="color161616 svgShape"
      ></path>
      <path
        fill="#fe9526"
